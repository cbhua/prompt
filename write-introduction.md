...
- Answer the questions by carefully thinking about the logical connection between each other. Treat these questions as a draft that can be directly written as an introduction. 

**What's the observation?**
- Review related papers, and find the phenomenon existing in previous works to support the reason for our work.
